          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label for="modal-duration" class="block text-sm font-medium text-gray-700">Duration (minutes)</label>
                  <input
              ...
              <div>
                <label for="modal-jira" class="block text-sm font-medium text-gray-700">Jira Issue (Optional)</label>
                <input
